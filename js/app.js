//Traffic Widget Data
    ...
    var weeklyTrafficData = {
        ...
        datasets: [
            {
                data: [0,750,1250,1000,1500,2000,1500,1750,1250,1750,2000,1750,2250],
    ...
    var hourlyTrafficData = {
        ...
        datasets: [
            {
                data: [0,1500,1750,1250,1750,2000,1750,2250,750,1250,1000,1500,2000],
    ...
    var todayTrafficData = {
      ...
      datasets: [
          {
              data: [0,1750,1250,1500,1750,2250,750,1250,1500,2000,1000,1750,2000],
    ...
    var monthlyTrafficData = {
      ...
      datasets: [
          {
              data: [0,1750,1250,1750,1500,2000,2000,1750,2250,750,1500,1250,1000],
...
var newMemberAvatar = document.getElementById("new-member-list").querySelectorAll("li .member-avatar");
    ...
    var newMemberData = [
        {"name": "Casey Jones",
          "image": "http://www.radfaces.com/images/avatars/casey-jones.jpg",
          "icon": "icons/post.svg",
        ...
        {"name": "Kel Mitchell",
          "image": "http://www.radfaces.com/images/avatars/kel-mitchell.jpg",
          "icon": "icons/like.svg",
          "email": "kel-mitchell@email.com",
          "date": "04/16/16",
        ...
        {"name": "Alan Frog",
          ...
          "email": "alan.frog@email.com",
          "date": "08/22/16",
          "activity": " commented on YourApp\'s SEO tips",
          "activity_time": "3 hours ago"},
        {"name": "Tina Carlyle",
          "image": "http://www.radfaces.com/images/avatars/tina-carlyle.jpg",
          "icon": "icons/like.svg",
          "email": "tina.carlyle@email.com",
          "date": "02/22/16",
          "activity": " signed up for YourApp",
          "activity_time": "1 hours ago"},
        {"name": "Tre Styles",
          "image": "http://www.radfaces.com/images/avatars/tre-styles.jpg",
          "icon": "icons/post.svg",
          "email": "tre.styles@email.com",
          "date": "11/09/16",
          "activity": " posted Facebook\'s 2016 changes",
          "activity_time": "9 hours ago"}
        ];
